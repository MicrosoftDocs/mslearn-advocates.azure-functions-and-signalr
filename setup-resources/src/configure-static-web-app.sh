...
echo "Adding the environment variable to the Static Web App..."
az staticwebapp appsettings set --name $staticWebAppName --resource-group $resourceGroup --settings COSMOS_CONNECTION_STRING=$cosmosDbConnectionString
...
# Add the environment variable to the Static Web App
echo "Adding the SignalR connection string environment variable to the Static Web App..."
az staticwebapp appsettings set --name $staticWebAppName --resource-group $resourceGroup --settings SIGNALR_CONNECTION_STRING=$signalrConnectionString
echo "SignalR connection string environment variable added."